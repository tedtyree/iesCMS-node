...
<!-- #include virtual="\barc\default.config" -->
...
'*****************************************************************************
   ...
   Function GenEditLink() as String
	...
	If wLevel>=wMinEditLevel Then
	  ...
	  If PopupEditWindow=True Then
	    GenEditLink="<a hRef=""#"" onClick=""Javascript:pup=window.open('" & EditURL & "','WObjEditor','menubar=no,status=no,width=950,height=700,toolbar=no,scrollbars=yes,location=no,directories=no,resizable=yes');pup.focus();return false;"" style='color:#FFFFFF'>" & LinkTitle & "</a>"
	  Else
	    GenEditLink="<a hRef='" & EditURL & "' style='color:#FFFFFF'>" & LinkTitle & "</a>"
	  End If
	End If
   ...
   Function GenAdminLink() as String
	...
	If wLevel>=wMinEditLevel Then
	  ...
	  GenAdminLink="<a hRef='" & AdminLinkURL & "' style='color:#FFFFFF'>" & AdminLinkTitle & "</a>"
